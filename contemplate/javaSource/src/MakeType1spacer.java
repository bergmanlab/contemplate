...
/**
 * This class creates an instance of the Type 1 Spacer submodel 
 ...
 * A Type 1 Spacer submodel created and initialized by this class
 * can be used for subsequent training with TrainType1spacer.
 * <br><br>
 * Use as follows:<br>
 * <pre>
 * java MakeType1spacer &lt;no of match/mismatch only stages&gt; &lt;no of mixed stages&gt; &lt;%GC seq 0&gt; &lt;%GC seq 1&gt; &lt;initial self transition weighting&gt;
 * </pre>
 * <p>
...
public class MakeType1spacer
{
    public static void main(String [] args)
        throws Exception
    {
        if (args.length != 5) {
            System.out.println("Usage: java MakeType1spacer <no of mismatch only stages> <no of mixed stages> <%GC seq 0> <%GC seq 1> <initial self transition weighting>");
            System.exit(1);
        }
        ...
        Type1spacer thisType1spacer = new Type1spacer(nMatchOnlyStages, nMixedStages, DNATools.getDNA(), DNATools.getDNA());
        ...
        thisType1spacer.setSeq0Dist(seq0Dist);

        // create and set a seq 1 dist
        Distribution seq1Dist = makeDNADistribution(Double.parseDouble(args[3]));

        thisType1spacer.setSeq1Dist(seq1Dist);


        Distribution dna2Dist = new PairDistribution(seq0Dist, seq1Dist);

        thisType1spacer.setEmissionDist(dna2Dist);

        thisType1spacer.setModelParameters(Double.parseDouble(args[4]), 1.0, 1.0, 1.0);
